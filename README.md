...
```url
https://hackathon-8.orb.ru/api/users/auth/login_as_root?code=+7<code>
```

*для защиты от злоупотреблений, кодом установлен номер телефона Дмитрия Сергеевича Вечеренко
